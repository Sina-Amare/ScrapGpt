...
from app.core.security import token_predates_password_change, verify_token
...
async def get_current_user(
    ...
    # Reject tokens issued before the user's last password change (e.g. a
    # password reset) so a reset invalidates existing sessions.
    if token_predates_password_change(payload.iat, user.password_changed_at):
        raise credentials_exception
